ATTACH TABLE _ UUID 'a7802460-66e8-4ffc-8c76-63bb3128fd20'
(
    `query_id` String COMMENT 'Query ID.' CODEC(ZSTD(1)),
    ...
    `event_time_microseconds` DateTime64(6) COMMENT 'Event time with microseconds resolution.' CODEC(Delta(4), ZSTD(1)),
    `memory_usage` UInt64 COMMENT 'Amount of RAM the query uses. It might not include some types of dedicated memory.',
    `peak_memory_usage` UInt64 COMMENT 'Maximum amount of RAM the query used.',
    ...
    `ProfileEvent_TextIndexReadDictionaryBlocks` UInt64 COMMENT 'Number of times a dictionary block has been read from the text index.',
    ...
    `ProfileEvent_TextIndexBloomFilterTrueNegatives` UInt64 COMMENT 'Number of times a token has been filtered by bloom filter.',
    `ProfileEvent_TextIndexBloomFilterTruePositives` UInt64 COMMENT 'Number of times a token has passed the bloom filter and has been found in the dictionary.',
    `ProfileEvent_TextIndexBloomFilterFalsePositives` UInt64 COMMENT 'Number of times a token has passed the bloom filter and has not been found in the dictionary.',
    ...
    `ProfileEvent_AzureGetRequestThrottlerCount` UInt64 COMMENT 'Number of Azure GET requests passed through throttler.',
    ...
    `ProfileEvent_DiskAzureGetRequestThrottlerCount` UInt64 COMMENT 'Number of Azure disk GET requests passed through throttler.',
    ...
    `ProfileEvent_AzurePutRequestThrottlerCount` UInt64 COMMENT 'Number of Azure PUT requests passed through throttler.',
    ...
    `ProfileEvent_DiskAzurePutRequestThrottlerCount` UInt64 COMMENT 'Number of Azure disk PUT requests passed through throttler.',
...
COMMENT 'Contains history of memory and metric values from table system.events for individual queries, periodically flushed to disk.\n\nIt is safe to truncate or drop this table at any time.'
